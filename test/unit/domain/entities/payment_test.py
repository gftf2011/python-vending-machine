...
class Test_Payment_Entity:
    ...
    def test_should_create_sut(self):
        ...
        sut: PaymentEntity = PaymentEntity(
            payment_id, order_id, payment_type, amount, payment_date
        )
...
class Test_Cash_Payment_Entity:
    ...
    def test_should_raise_exception_by_using_constructor(self):
        ...
        with pytest.raises(
            Exception,
            match="Use the 'create' method to create an instance of this class.",
        ):
            CashPaymentEntity(
                payment_id, order_id, payment_type, amount, payment_date, cash_tendered
            )
